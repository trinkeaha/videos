...
<head>
    ...
    <script>
        ...
        $(function(){
            ...
            //div 两个哪个显示呢？
            if(null!="${sessionScope.loginUser}" && "${sessionScope.loginUser}" !=""){
...
<nav class="w100">
    <div class="container">
        <img src="${pageContext.request.contextPath}/img/logo.png" alt="Y先生教育的logo" onclick="location.href='#'" draggable="false">
...
<div class="mask hidden" id="login">
    <div class="mask_content">
        ...
        <div class="mask_content_body" onsubmit="return false;">
    ...
    <div class="mask_content">
        ...
        <div class="mask_content_body">
            <form id="regForm" action="insertUser.action">
                <h3>新用户注册</h3>
                <input type="email" id="regEmail" placeholder="请输入邮箱" name="email" autocomplete="off"><span id="emailMsg"></span>
                <input type="password" id="regPsw" placeholder="请输入密码" name="password" autocomplete="off">
...
<script type="text/javascript">
    ...
    function getVideo(videoId){
        ...
        //判断用户是否登录
        //alert($("#isLogin").val());
        if((null!="${sessionScope.loginUser}" && "${sessionScope.loginUser}" !="") || ($("#isLogin").val()==1)){
            //如果登录
            location.href="/videos/showVideo.do?videoId="+videoId+"&subjectName="+'${subject.subjectName}';
        }else{
            //如果不登录，弹登录框
